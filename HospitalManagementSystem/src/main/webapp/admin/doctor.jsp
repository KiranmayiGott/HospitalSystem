				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<form action="../addDoctor" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Speciality</label> <select name="spec"
				...
				<div class="card paint-card">
					<div class="card-body">
						...
						<c:if test="${not empty updateErrorMsg}">
							<p class="fs-5 text-center text-danger">${updateErrorMsg}</p>
							<c:remove var="updateErrorMsg" scope="session" />
						</c:if>
						<c:if test="${not empty updateSuccMsg}">
							<div class="fs-5 text-center text-success" role="alert">${updateSuccMsg}</div>
							<c:remove var="updateSuccMsg" scope="session" />
						</c:if>
						<div style="max-height: 640px; overflow: auto; display: block; white-space: nowrap;">
							<table class="table">
								<thead>
									<tr>
